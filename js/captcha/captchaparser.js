...
const solve = (img, textB) => {
  fetch(
    "moz-extension://6a850382-ada5-4a65-96c5-0ad0ccfba2f7/js/captcha/weights.json"
  )
...
function myMain(evt) {
  if (document.URL.match("https://vtopcc.vit.ac.in/vtop/initialProcess")) {
  ...
  } else if (document.URL.match("vtop.vitap.ac.in/vtop/login")) {
    ...
    if (img === null) {
      ...
      //   "form-control img-fluid bg-light border-0"
      // )[0];
      var img =  document.querySelector('img.form-control');
      if (img === null) {
